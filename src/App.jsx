      ...
      return (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: '1.4rem', marginBottom: '12px', color: '#f87171' }}>
              ⚠️ Application Recovery Mode
            </h2>
            <p style={{ color: '#94a3b8', fontSize: '0.9rem', marginBottom: '24px', lineHeight: 1.6 }}>
              A temporary browser rendering issue occurred. Click below to reset local state and restore Code Companion.
            </p>
            <button
            ...
            >
              Reset State &amp; Reload Application
            </button>
          </div>
        </div>
      );
